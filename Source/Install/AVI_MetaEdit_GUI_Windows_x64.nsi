...
OutFile "..\..\Release\AVI_MetaEdit_GUI_${PRODUCT_VERSION}_Windows_x64.exe"
InstallDir "$PROGRAMFILES64\U.S. National Archives\${PRODUCT_NAME}"
...
Section "SectionPrincipale" SEC01
  ...
  SetOutPath "$INSTDIR"
  File "/oname=\${PRODUCT_NAME_EXE}" "..\..\Project\MSVC2015\GUI\x64\Release\AVI_MetaEdit_GUI.exe"
