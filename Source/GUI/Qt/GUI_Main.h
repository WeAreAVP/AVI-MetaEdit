...
public Q_SLOTS:
    ...
    void OnMenu_Rules_AVI_Req                       (bool);
    void OnMenu_Rules_AVI_Rec                       (bool);
    ...
    void OnMenu_Rules_USNA_Rec                     (bool);
    void OnMenu_Options_TechCore                    (bool);
    void OnMenu_Options_Avi2Avix_Reject             (bool);
    ...
    void OnMenu_Help_Brand_Website                  ();
    void OnOpen_Timer                               ();
