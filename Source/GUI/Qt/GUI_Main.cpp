...
GUI_Main::GUI_Main(Core* _C)
{
    ...
    move(80, 220);
    resize(QApplication::desktop()->screenGeometry().width()-160, QApplication::desktop()->screenGeometry().height()-440);
    ...
    Menu_Rules_AVI_Req->setChecked(true);
    emit OnMenu_Rules_AVI_Req();
...
//---------------------------------------------------------------------------
void GUI_Main::View_Refresh_Default()
{
    //Defaults
...
void GUI_Main::Open_Timer_Init (open_timer_init Action)
{
    ...
    ProgressDialog->setWindowTitle("AVI MetaEdit");
